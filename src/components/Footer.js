...
import { getFooterSettings } from "@/lib/content";
        ...
        <div className="container footer-grid">
          ...
          <div className="footer-col brand-col">
            ...
            <div className="social-links">
              {footer.linkedin ? <a href={footer.linkedin} aria-label="LinkedIn" target="_blank" rel="noreferrer">
              ...
              {footer.instagram ? <a href={footer.instagram} aria-label="Instagram" target="_blank" rel="noreferrer">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              {footer.youtube ? <a href={footer.youtube} aria-label="YouTube" target="_blank" rel="noreferrer">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                  strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <div className="footer-bottom">
        <div className="container footer-bottom-inner">
          <div className="footer-bottom-left">
            <p className="footer-bottom-copy">{footer.copyright}</p>
          </div>
